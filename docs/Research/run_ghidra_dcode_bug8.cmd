...
set "REPORT=%RESEARCH%DCodeBug8GhidraReport.txt"

"%GHIDRA_HEADLESS%" "%PROJECT_DIR%" "%PROJECT_NAME%" -process BBCF.exe -noanalysis -scriptPath "%SCRIPT_DIR%" -postScript DecompileDCodeBug8.py "%REPORT%"
