...
set "REPORT=%RESEARCH%RankedDelay3GhidraReport.txt"

"%GHIDRA_HEADLESS%" "%PROJECT_DIR%" "%PROJECT_NAME%" -process BBCF.exe -noanalysis -scriptPath "%SCRIPT_DIR%" -postScript DecompileRankedDelay3.py "%REPORT%"
