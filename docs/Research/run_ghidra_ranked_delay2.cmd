...
set "REPORT=%RESEARCH%RankedDelay2GhidraReport.txt"

"%GHIDRA_HEADLESS%" "%PROJECT_DIR%" "%PROJECT_NAME%" -process BBCF.exe -noanalysis -scriptPath "%SCRIPT_DIR%" -postScript DecompileRankedDelay2.py "%REPORT%"
