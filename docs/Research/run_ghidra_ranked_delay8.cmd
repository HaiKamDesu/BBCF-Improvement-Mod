...
set "REPORT=%RESEARCH%RankedDelay8GhidraReport.txt"

"%GHIDRA_HEADLESS%" "%PROJECT_DIR%" "%PROJECT_NAME%" -process BBCF.exe -noanalysis -scriptPath "%SCRIPT_DIR%" -postScript DecompileRankedDelay8.py "%REPORT%"
