...
set "REPORT=%RESEARCH%NamedSymbolsGhidraReport.txt"

"%GHIDRA_HEADLESS%" "%PROJECT_DIR%" "%PROJECT_NAME%" -process BBCF.exe -noanalysis -scriptPath "%SCRIPT_DIR%" -postScript SearchNamedSymbols.py "%REPORT%"
