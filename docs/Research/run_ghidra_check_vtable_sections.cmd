...
set "REPORT=%RESEARCH%CheckVtableSectionsReport.txt"

"%GHIDRA_HEADLESS%" "%PROJECT_DIR%" "%PROJECT_NAME%" -process BBCF.exe -noanalysis -scriptPath "%SCRIPT_DIR%" -postScript CheckVtableSections.py "%REPORT%"
