...
set "REPORT=%RESEARCH%PaletteSymbolsGhidraReport.txt"

"%GHIDRA_HEADLESS%" "%PROJECT_DIR%" "%PROJECT_NAME%" -process BBCF.exe -noanalysis -scriptPath "%SCRIPT_DIR%" -postScript DumpPaletteSymbols.py "%REPORT%"
