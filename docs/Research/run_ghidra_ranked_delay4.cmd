...
set "REPORT=%RESEARCH%RankedDelay4GhidraReport.txt"

"%GHIDRA_HEADLESS%" "%PROJECT_DIR%" "%PROJECT_NAME%" -process BBCF.exe -noanalysis -scriptPath "%SCRIPT_DIR%" -postScript DecompileRankedDelay4.py "%REPORT%"
