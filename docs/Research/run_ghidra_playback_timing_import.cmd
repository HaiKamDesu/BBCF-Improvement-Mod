...
set "REPORT=%RESEARCH%PlaybackTimingImportReport.txt"

"%GHIDRA_HEADLESS%" "%PROJECT_DIR%" "%PROJECT_NAME%" -import "%BBCF_EXE%" -overwrite -analysisTimeoutPerFile 1800 -scriptPath "%SCRIPT_DIR%" -postScript DecompilePlaybackTiming.py "%REPORT%"
