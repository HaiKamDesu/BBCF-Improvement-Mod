# -*- coding: utf-8 -*-
# Ghidra headless Jython script, phase 15: CUMSTask download/share implementations.
...
FUNCTION_ADDRS = [
    0x00422830,  # download path (reqId +0x94 nonzero) -- sets errFlags/EResult
    0x004237b0,  # share/upload path (+0x90 nonzero)
    0x00422680,  # dtor helper
]
