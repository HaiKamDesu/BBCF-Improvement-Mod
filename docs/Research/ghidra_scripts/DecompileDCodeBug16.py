# -*- coding: utf-8 -*-
# Ghidra headless Jython script, phase 16: the dedicated bbdc.dat transfer paths (taken when request name == bbdc.dat): FUN_00422B00 download, FUN_00423A50 share. Find the abort-without-result conditions and errFlags bit meanings.
...
FUNCTION_ADDRS = [
    0x00422b00,  # bbdc.dat download implementation (Steam UGC)
    0x00423a50,  # bbdc.dat share implementation (Steam FileShare)
    0x00422b00,
]
