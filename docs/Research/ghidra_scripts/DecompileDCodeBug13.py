# -*- coding: utf-8 -*-
# Ghidra headless Jython script, phase 13: CUserManagedStorage worker internals.
...
FUNCTION_ADDRS = [
    0x00422410,  # worker ctor (0x110 bytes) -- thread proc / callback setup
    0x0041fb80,  # enqueue into work queue
    0x0041fc20,  # queue kick / signal
    0x0041ab10,  # per-request start
]
