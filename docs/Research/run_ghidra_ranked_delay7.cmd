...
set "REPORT=%RESEARCH%RankedDelay7GhidraReport.txt"

"%GHIDRA_HEADLESS%" "%PROJECT_DIR%" "%PROJECT_NAME%" -process BBCF.exe -noanalysis -scriptPath "%SCRIPT_DIR%" -postScript DecompileRankedDelay7.py "%REPORT%"
