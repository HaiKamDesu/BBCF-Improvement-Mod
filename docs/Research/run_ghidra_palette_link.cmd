...
set "REPORT=%RESEARCH%PaletteLinkGhidraReport.txt"

"%GHIDRA_HEADLESS%" "%PROJECT_DIR%" "%PROJECT_NAME%" -process BBCF.exe -noanalysis -scriptPath "%SCRIPT_DIR%" -postScript DecompilePaletteLink.py "%REPORT%"
